                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('products-mitra.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method("PUT")
                                             <div class="form-group">
                                              ...
                                              <select name="user_id" required  class="form-control">
                                                  ...
                                                  <option value="{{ $item->id }}" {{ $item->id == $product->user_id ? 'selected' : '' }}>{{ $item->name }}</option>
